// refer this guy.... removed get portion
...
var SS = SpreadsheetApp.openById('1zeg2bhGSMP3Ncj-RINvPiKG_HMTyn6U');    //Enter Your Sheet ID Got From Sheet URL Link
  ...
  if (parsedData !== undefined){
    ...
    switch (parsedData.command) {
      case "appendRow":
         ...
         var nextFreeRow = tmp.getRange("C1").getDataRegion().getLastRow()+1;
